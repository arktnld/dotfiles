...
function add_keybinds()
  mp.add_forced_key_binding('CTRL+k', 'moveup', moveup, "repeatable")
  mp.add_forced_key_binding('CTRL+j', 'movedown', movedown, "repeatable")
...
mp.add_key_binding("CTRL+s", "sortplaylist", sortplaylist)
mp.add_key_binding("CTRL+r", "shuffleplaylist", shuffleplaylist)
