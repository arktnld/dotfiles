...
" Toggle cursor line in Insert/Normal mode.
augroup togglecursorline
	autocmd!
	autocmd InsertEnter,BufLeave,WinLeave,FocusLost * call autocmds#togglenumbers#('setlocal nocursorline')
	autocmd InsertLeave,BufEnter,WinEnter,FocusGained * call autocmds#togglenumbers#('setlocal cursorline')
augroup end
